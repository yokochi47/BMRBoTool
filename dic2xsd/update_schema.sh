...
DictToSdb -ddlFile mmcif_nmr-star_ddl.dic -dictFile $NMRSTAR_DICT_FILE -dictSdbFile $DICT_PREFIX.sdb
...
sed -i 's/="http:\/\/pdbml.pdb.org/="http:\/\/bmrbpub.protein.osaka-u.ac.jp/' $DICT_PREFIX-v$DICT_VERSION.xsd
...
cp -f $DICT_PREFIX-v$DICT_VERSION.xsd ../schema/$DICT_PREFIX.xsd
